...
Перед тем как выполнять задание создайте отдельную векту в git:
```bash
git checkout -b new_branch_name
```

После выполнения задания влейте изменения из отдельной ветки в main:

```bash
git merge <hash коммита>
```
